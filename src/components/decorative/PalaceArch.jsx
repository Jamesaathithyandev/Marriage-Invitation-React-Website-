  ...
  return (
    ...
    >
      ...
      >
        {/* Crown Motif / Finial */}
        {crownMotif !== 'none' && (
          <div className="absolute -top-6 sm:-top-7 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center">
            {crownMotif === 'lotus' && (
              <LotusMotif variant="crest" size="md" className="drop-shadow-[0_2px_8px_rgba(198,166,107,0.4)]" />
            )}
            {crownMotif === 'peacock' && (
              <PeacockMotif variant="feather-crown" size="md" className="drop-shadow-[0_2px_8px_rgba(198,166,107,0.4)]" />
            )}
            {crownMotif === 'finial' && (
              <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8">
                <path d="M20 2 L25 14 L20 22 L15 14 Z" fill="#C6A66B" stroke="#9E7E45" strokeWidth="0.75" />
        ...
        <div className="w-full max-w-md mx-auto pt-4 sm:pt-6 pb-2">
          ...
          >
            ...
            <circle cx="160" cy="8" r="2.5" fill="#C6A66B" />
        ...
        {hasCornerAccents && (
          <div className="flex justify-between items-center px-2 pt-3">
            <svg viewBox="0 0 30 30" fill="none" className="w-5 h-5 text-gold/60">
