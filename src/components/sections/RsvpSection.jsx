      ...
      <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-8 sm:mb-10">
          ...
          <p className="font-serif text-base sm:text-lg text-palace-green/90 mt-2.5 max-w-lg mx-auto leading-relaxed">
            ...
            <strong className="font-semibold text-palace-green">24th &amp; 25th October 2026</strong>.
          </p>
              ...
              <div className="space-y-7 text-left">
                <div className="text-center">
                  ...
                  <p className="font-serif text-sm sm:text-base text-palace-green/70 mt-1">
                    Fill in your details &amp; select the events you'll attend.
                  </p>
                </div>
              ...
              <div className="space-y-6 text-center">
                ...
                <div className="space-y-3">
                  ...
                  <p className="font-serif text-sm sm:text-base text-palace-green/85 max-w-md mx-auto leading-relaxed pt-1.5">
                    We eagerly await welcoming you to our celebrations in Bengaluru on{' '}
                    <span className="font-semibold text-palace-green">24th &amp; 25th October 2026</span>.
                  </p>
                </div>
